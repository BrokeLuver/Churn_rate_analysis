# Churn_rate_analysis
# **‼️Данный проект и резюме, к которому он был прикреплен считается устаревшим. Пожалуйста, ознакомьтесь с моим актуальным резюме и его проектами (https://github.com/BrokeLuver/Resume)‼️**
